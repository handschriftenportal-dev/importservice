...
public class KulturObjektDokumentImportServiceTest {
  ...
  void testImportDateien() throws IOException, ActivityStreamsException {
    ...
    String filename = "kulturObjektDokumente.xml";

    File file = ResourceUtils.getFile("classpath:" + filename);
    byte[] content = Files.readAllBytes(file.toPath());

    KulturObjektDokumentImportService service = new KulturObjektDokumentImportService("/tmp", xmlService, fileService,
    ...
    ImportJob job = service.importDateien(activityStreamObject, filename, "Konrad", ActivityStreamsDokumentTyp.KOD);
